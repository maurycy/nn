...
# Improved Hypertensor Layer with BatchNorm
...
# Enhanced network architecture with larger layers and BatchNorm
class HypertensorMNISTNetwork(nn.Module):
    def __init__(self, input_shape=(28, 28), hidden_size=256):  # Increased to 256
        ...
        self.fc1 = nn.Linear(hidden_size, 128)  # Increased to 128
        self.bn1 = nn.BatchNorm1d(128)

        # Second fully connected layer with batch norm
        self.fc2 = nn.Linear(128, 64)  # Added intermediate layer
