...
# Improved Hypertensor Layer with better initialization
...
# Improved network architecture with larger layers
class HypertensorMNISTNetwork(nn.Module):
    def __init__(self, input_shape=(28, 28), hidden_size=128):  # Increased hidden size
        ...
        self.fc1 = nn.Linear(hidden_size, 64)  # Larger intermediate layer
